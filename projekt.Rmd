...
1. Proizvedba žitaric v celotni Sloveniji od leta 2010 do 2019 
...
2. Proizvedba žitaric po Slovenskih regijah od leta 2010 do 2019 
  - `žitarice` (Character)- Vrsta proizvedene žitarice,
  - `Regija` (Character)- Območje proivedenih žitaric,
  - `leto` (Numeric)- Leto prozvedene žitarice,
  - `Kolicina`(Numeric)- spremenljivka: količina proizvdenih žitaric,
  
3. Tabela, ki vsebuje proivedbo žitaric tako kot podatke o velikosti regije in njihovih prebivalcih
